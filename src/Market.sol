...
contract Market is IERC1155Receiver, ReentrancyGuard {
    ...
    event Liquidate(address indexed liquidator, address indexed borrower, uint256 collateralSeized, uint256 debtRepaid);
    ...
    function deposit(uint256 amount) external nonReentrant {
        ...
        polymarketCTF.safeTransferFrom(msg.sender, address(this), collateralTokenId, amount, "");
    ...
    function withdraw(uint256 amount) external nonReentrant {
        ...
        polymarketCTF.safeTransferFrom(address(this), msg.sender, collateralTokenId, amount, "");
    ...
    function repay(uint256 amount) external nonReentrant {
        ...
        uint256 interest = repayAmount > position.borrowedAmount ? 0 : position.borrowedAmount - repayAmount;
    ...
    function liquidate(address borrower, uint256 repayAmount) external nonReentrant {
        ...
        uint256 debtToRepay = repayAmount > position.borrowedAmount ? position.borrowedAmount : repayAmount;
        ...
        polymarketCTF.safeTransferFrom(address(this), msg.sender, collateralTokenId, collateralWithDiscount, "");
    ...
    function _calculateDebtWithInterest(address user) internal view returns (uint256) {
        ...
        uint256 interestAccrued =
            (position.borrowedAmount * interestRatePerYear * timeElapsed) / (BASIS_POINTS * SECONDS_PER_YEAR);
